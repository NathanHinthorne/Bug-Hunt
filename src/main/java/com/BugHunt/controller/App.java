...
import com.BugHunt.model.cards.CardFamily;
import com.BugHunt.model.players.Player;
import com.BugHunt.view.AudioManager;
import com.BugHunt.view.GameScreen.GameScreen;
import com.BugHunt.view.IntroScreen.IntroScreen;
import com.BugHunt.view.TitleScreen.TitleScreen;
...
public class App extends Application implements java.io.Serializable {
    ...
    private void startGame(Stage gameStage) {
        ...
        if (DEBUG_MODE) {
            ...
            gameScreen.getInfoBanner().displayInfo("Welcome to the game of BUG HUNT!", Color.CORNFLOWERBLUE, 4);
            ...
            pause.setOnFinished(event -> {
                ...
                pause2.setOnFinished(event2 -> {
                    gameScreen.getInfoBanner().displayInfo("Good luck and have fun!",
                            Color.CORNFLOWERBLUE, 4);
